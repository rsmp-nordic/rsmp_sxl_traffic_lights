...
.. figtable::
   ...
   Name    Type     Value               Comment
   ======  =======  ==================  ===============================================================================================
   user    integer  -0 |br| -1 |br| -2  0: Nobody logged in |br| 1: Operator logged in at level 1 |br| 2: Operator logged in at level 2
   ======  =======  ==================  ===============================================================================================
..
...
.. figtable::
   ...
   Name          Command    Type    Value    Comment
   ============  =========  ======  =======  ==================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================
   status        setInput   string  [text]   Sets/Unsets a block of 16 inputs at a time. Can be repeated to set several blocks of 16 inputs. Values are separated with comma. Blocks are separated with semicolon. |br| Format: [Offset];[Bits to set];[Bits to unset];… |br|  |br| Offset sets where the 16 inputs starts from followed by two 16 bit values telling which bit to set and unset in binary format, i.e. first bit have value 1 and last bit have value 32768. |br|  |br| Example 1: |br| "5,4134,65" sets input 6,7,10,17 to 1 and  5,11 = 0 |br| - Input starts from no. 5 |br| - "4134" is 1 0000 0010 0110 in binary, but since input starts from 5, it is shifted 5 bits, e.g. 10 0000 0100 1100 0000 which are bits 6,7,10,17 |br| - "65" is 100 0001 in binary, but since input starts from 5, it is shifted 5 bits, e.g. 1 000 0010 0000 which are bits 5,11 |br|  |br| Example 2: |br| "22,1,4" sets input 23 = 1 and 24 = 0 |br| - "1" is 1 in binary, but since input starts at 22, it is shifted 22 bits, e.g. 100 0000 0000 0000 0000 0000, which is bit 22 |br| - "4" is 100 in binary, but since input starts at 22, it is shifted 22 bits, e.g. 1 0000 0000 0000 0000 0000 0000, which is bit 24 |br|  |br| And both these examples could be sent in the same message as: |br| "5,4143,65;22,1,4" |br|  |br| Such a message would activate input 6,7,10,17,22 and deactivate input 5,11,24 |br|  |br| Example 3: |br| "0,1,2" sets input 0 = 1 and 1 to = 0 |br| - "1" is 1 in binary |br| - "2" is 10 in binary
   securityCode  setInput   string  [text]   Security code 2
   ============  =========  ======  =======  ==================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================
..
